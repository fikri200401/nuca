                ...
                <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
                    <table class="min-w-full divide-y divide-gray-300">
                        <thead class="bg-gray-50">
                            <tr>
                                <th class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6">Gambar</th>
                        ...
                        <tbody class="divide-y divide-gray-200 bg-white">
                            ...
                            <tr>
                                <td class="whitespace-nowrap py-4 pl-4 pr-3 sm:pl-6">
                                    @if($treatment->image)
                                        <img src="{{ asset('storage/' . $treatment->image) }}" alt="{{ $treatment->name }}" class="h-16 w-16 rounded object-cover">
                                    @else
                            ...
                            <tr>
                                <td colspan="5" class="px-3 py-8 text-center text-sm text-gray-500">
                                    Belum ada treatment.
                                    @canDo('treatments', 'add')
                                    <a href="{{ route('admin.treatments.create') }}" class="text-indigo-600">Tambah treatment pertama</a>
                                    @endCanDo
                                </td>
                            </tr>
                            @endforelse
